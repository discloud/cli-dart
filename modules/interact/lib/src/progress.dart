...
class _ProgressState extends State<Progress> {
  ...
  void render() {
    ...
    line
      ..write(leftPrompt)
      ..write(component.theme.progressPrefix)
      ..write(
        _progress(
          component.theme,
          available,
      ...
      ..write(component.theme.progressSuffix)
      ..write(rightPrompt);
  ...
  String _progress(Theme theme, int length, int filled) {
    final f = theme.filledProgressStyle(
      "".padRight(filled - 1, theme.filledProgress),
    );
    final l = filled == 0
        ? ""
        : filled == length
    ...
    final e = theme.emptyProgressStyle(
      "".padRight(length - filled, theme.emptyProgress),
    );
