...
class _SelectState extends State<Select> {
  ...
  void render() {
    for (int i = 0; i < component.options.length; i++) {
      ...
      if (i == index) {
        line
          ..write(component.theme.activeItemPrefix)
          ..write(" ")
          ..write(component.theme.activeItemStyle(option));
      } else {
        line
          ..write(component.theme.inactiveItemPrefix)
          ..write(" ")
          ..write(component.theme.inactiveItemStyle(option));
      }
